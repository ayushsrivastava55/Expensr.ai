  ...
  React.useEffect(() => {
    ...
    getSummary()
      ...
      .catch((err) => {
        ...
        setSummary(null);
        // Already logged in api.ts, but log again with context
        console.error("[Home] Failed to fetch summary:", err);
      })
    ...
    <div className="bg-white">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Demo API summary call with error handling */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-2">Live API Status</h3>
            {loading && <div className="text-gray-500">Loading summary...</div>}
            {error && (
